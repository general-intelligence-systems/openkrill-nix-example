...
Based on the identified issue, consult `scripts/references/troubleshooting_workflow.md` for detailed workflows:
...
Refer to `scripts/references/common_issues.md` for specific solutions to common problems.
...
Consult `scripts/references/troubleshooting_workflow.md` for:
...
Consult `scripts/references/common_issues.md` for:
